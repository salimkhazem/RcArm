        ...
        fifoCount -= packetSize;
            ...
            if (etat==1) {
             ...
             if(data[2]<0) {data[2]=0;}
              ...
              Serial.print("Axe X :"); Serial.print("\t");    Serial.print(data[0]); Serial.print("\t");
              Serial.print("Axe Y :"); Serial.print("\t");    Serial.print(data[1]); Serial.print("\t");
           ...
           char x[2]; 
            ...
            data[2]=map(analogRead(posZ),0,1023,0,180); 
           radio.write(&data,sizeof(data)); 
